...
r_k = 252359.5; # рисковая надбавка
...
r_u = 426332.4; # рисковая надбавка

t_r = (r_l + r_k + r_u)/3; # общая рискровая надбавка
...
def calculate(sex_, exp_, model_, tinsur_):
  ...
  return (p_l*m_l + p_k*m_k + p_u*m_u); # + t_r удалил
...
t = round(calculate(sex, exp, model, tinsur), 2);
